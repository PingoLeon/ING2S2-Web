...
<div class="container" id="background">
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            $query = 'SELECT Offre_Emploi.Intitule, Offre_Emploi.Debut, Offre_Emploi.Fin, Offre_Emploi.Position, Offre_Emploi.Type_Contrat, Offre_Emploi.Logo AS Photo, Offre_Emploi.Texte, Enterprise.Nom_Entreprise, Enterprise.Logo
                      FROM Offre_Emploi
